          ...
          <div className="xl:col-span-3">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6">
                          <div className="bg-black/40 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                            <p className="text-white text-sm leading-relaxed font-medium">
                              "Привет! Сегодня я расскажу вам о топ-5 секретах в сфере стройматериалов, которые помогут
                              вам сэкономить до 30% на ремонте..."
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            {videoReady && (
              <div className="flex justify-center gap-4 mt-6">
                ...
                <Button variant="outline" size="lg" onClick={regenerateVideo} className="px-8 bg-transparent">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <div className="text-sm text-gray-600 leading-relaxed">
                  <p className="mb-2">
                    <strong>Хук:</strong> "Топ-5 секретов стройматериалов"
                  </p>
                  <p className="mb-2">
                    <strong>Основная часть:</strong> Рассказ о способах экономии при покупке материалов
                  </p>
                  <p>
